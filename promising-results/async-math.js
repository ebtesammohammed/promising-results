      ...
      .then((shouldResolve) => {
        if (shouldResolve) {
          ...
          return Promise.reject(
            new Error(`Error adding values ${a} and ${b}.`)
          );
        }
      });
  }
    ...
    return wait(1000)
      ...
      .then((shouldResolve) => {
        if (shouldResolve) {
          ...
          return Promise.reject(
            new Error(`Error subtracting values ${a} and ${b}.`)
          );
        }
      });
  }
    ...
    return wait(1000)
      ...
      .then((shouldResolve) => {
        if (shouldResolve) {
          ...
          return Promise.reject(
            new Error(`Error multiplying values ${a} and ${b}.`)
          );
        }
      });
  }
  ...
  function remainder(a, b) {
    return wait(1000)
      ...
      .then((shouldResolve) => {
        if (+b === 0) {
          return Promise.reject(
            new Error("Cannot divide by zero for remainder.")
          );
        } else if (shouldResolve) {
          return Promise.resolve(a % b);
        } else {
          return Promise.reject(
            new Error(`Error dividing ${a} by ${b} for remainder.`)
          );
        }
      });
  }
